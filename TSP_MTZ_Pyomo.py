## Problem: Traveling salesman problem (MTZ Formulation)
## Solver: Gurobi
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%
#  DEVELOPMENT PARTS
def TSP_MTZ_Formulation(n, costMatrix):
    #%
...
solutionObjective, solutionGap, tourRepo, runtimeCount, completeResults = TSP_MTZ_Formulation(n, costMatrix)
